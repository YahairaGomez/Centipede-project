...
bool colision(int x1, int y1, int w1, int h1,int y1, int y2, int w2, int h2);
...
void eliminar(struct Balas disparos[], int &n_disparos, int cont){
                    Balas Btemp; //creo un elemento e estructura balas llamado Btemp
                    Btemp = disparos[cont];
